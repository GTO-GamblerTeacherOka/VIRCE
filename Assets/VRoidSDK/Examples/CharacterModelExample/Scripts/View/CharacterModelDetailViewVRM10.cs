...
{
    public class CharacterModelDetailViewVRM10 : BaseView
    {
        ...
        public Message canUseAvatarByOtherUser;
        public Message canUseViolence;
        public Message canUseSexuality;
        public Message canUseReligionOrPolitical;
        public Message canUseAntisocialOrHatred;
        public Message canUseCommercial;
        public Message canUseCorporate;
        public Message canRedistribute;
        public Message canModify;
        public Message canRedistributeModified;
